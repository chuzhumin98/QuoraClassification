...
if __name__ == '__main__':
    path = './hidden_sizes'
    attri_nums = [50, 100, 150, 200, 250]
    attri_strs = ['{}'.format(n) for n in attri_nums]

    best_f1s = [0.669, 0.675, 0.669, 0.673, 0.671]
    ...
    plt.savefig('image/hidden_loss.png')
    ...
    plt.legend(attri_strs)
    plt.savefig('image/hidden_train_F1.png')
    ...
    plt.legend(attri_strs)
    plt.savefig('image/hidden_val_F1.png')
    ...
    plt.savefig('image/hidden_best_f1.png')
